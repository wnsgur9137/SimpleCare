...
- **Color+SimpleCare**: Primary(teal) / Secondary(blue) / Accent(purple), 영양소별 색상, BMI 색상 매핑, 식사 타입별 색상(Breakfast/Lunch/Dinner/Snack), 운동 강도 색상(Light/Moderate/Vigorous), 오버레이 색상
